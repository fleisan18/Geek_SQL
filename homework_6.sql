...
DELIMITER //
CREATE FUNCTION hello(in_time TIME)
RETURNS VARCHAR (20)
READS SQL DATA
BEGIN
	...
	SET hello = (
		IF(in_time BETWEEN '06:00:00' AND '12:00:00', 'Доброе утро', 
			IF(in_time BETWEEN '12:00:00' AND '18:00:00', 'Добрый день',
				IF(in_time BETWEEN '18:00:00' AND '00:00:00', 'Добрый вечер', 'Доброй ночи'))));
	RETURN hello;
END //

DELIMITER ;

SELECT hello('07:12:45');
SELECT hello('14:12:45');
SELECT hello('20:12:45');
SELECT hello('01:12:45');
